...
class Ejercicios1 extends StatefulWidget {
  Ejercicios1({Key key}) : super(key: key);

  @override
  _EjerciciosState createState() => _EjerciciosState();
}

class _EjerciciosState extends State<Ejercicios1> {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, Object>> _questions = const [
      {
        'questionText': 'Selecciona el símbolo de suma \n\n',
        'answers': [
      ...
      {
        'questionText': 'Selecciona el símbolo de resta \n\n',
        'answers': [
      ...
      {
        'questionText': 'Selecciona la imagen con el número 9 \n\n',
        'answers': [
          {
      ...
      {
        'questionText': 'Selecciona el símbolo de multiplicación \n\n',
        'answers': [
          {'image': 'assets/images/suma.png', 'result': 'Intentalo de nuevo'},
          {'image': 'assets/images/resta.png', 'result': 'Intentalo de nuevo'},
          {
      ...
      {
        'questionText': 'Selecciona la imagen con el número 6 \n\n',
        'answers': [
          {
            'image': 'assets/images/numero2.png',
            'result': 'Intentalo de nuevo'
